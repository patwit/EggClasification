...
circlelayer = DrawingLayer((img_with_circles.width, img_with_circles.height))
circlelayer.circle((591,539),50,filled=False, width=20, color = Color.BLACK)
img_with_circles.addDrawingLayer(circlelayer)
img_with_circles.applyLayers()
img_with_circles.show()
img_with_circles.save("images/image_with_circle.jpg")
raw_input("Press Enter to continue...")


crop_image = circles[-1].crop()
crop_image.show()
img_with_circles.save("images/crop_image.jpg")
raw_input("Press Enter to continue...")
#time.sleep(10)
